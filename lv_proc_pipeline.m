...
for nn=1:numel(sbj)
    ...
    if conditions == 2
        ...
        cleaned_data.trialinfo(ismember(cleaned_data.trialinfo(:,1),classes(1)),1 ) = 1;  
        cleaned_data.trialinfo(ismember(cleaned_data.trialinfo(:,1),classes(2)),1 ) = 2;
    else
...
% simulating an effect in erps around 0.5 second
all_data = erps_temp;
for i = 1:20
    random_val = 5 + rand * 15;
    erps_temp(1,:,100:150) = erps_temp(1,:,100:150)+random_val;
    erps_temp(2,:,100:150) = erps_temp(2,:,100:150)-random_val;
    all_data = [all_data ; erps_temp];
end
erps.trial = all_data;
